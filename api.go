...
func main() {
	...
	playground := types.Playground{Domain: config.PlaygroundDomain, DefaultDinDInstanceImage: "shashwatpp/dind", AvailableDinDInstanceImages: []string{"shashwatpp/dind"}, AllowWindowsInstances: config.NoWindows, DefaultSessionDuration: d, Extras: map[string]interface{}{"LoginRedirect": "http://localhost:3000"}, Privileged: true}
